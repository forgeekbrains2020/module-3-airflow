...
fill_dim_fct = PostgresOperator(
    ...
    # postgres_conn_id="postgres_default",
    sql="""
    insert into ayashin.pj_dm_dim_fct (billing_year_id, legal_type_id, district_id, billing_mode_id, registration_year_id, is_vip, payment_sum, traffic_amount)
